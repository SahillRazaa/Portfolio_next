...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col xl:flex-row px-4 sm:px-8 md:px-30 py-8 gap-8 items-stretch justify-center">
        <div className="flex-[2] bg-white/85 backdrop-blur-md rounded-3xl border border-slate-300/30 shadow-xl p-6 lg:p-10 relative overflow-hidden flex flex-col justify-between">
          <div className="relative z-10">
            ...
            <h2 className="text-base sm:text-lg lg:text-xl mt-8 font-normal max-w-xl text-slate-600 leading-relaxed">
          ...
          <div className="absolute top-1/2 left-[-10%] -translate-y-1/2 text-[10rem] lg:text-[22rem] font-black text-black/5 -z-10 select-none whitespace-nowrap tracking-tighter">
            SAHILRAZA
          </div>
