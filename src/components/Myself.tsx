...
const Myself = () => {
  ...
  return (
    <div id="recent" className="flex flex-col xl:flex-row px-4 sm:px-8 md:px-30 py-8 gap-8 items-stretch justify-center">
      <div className="flex-1 flex flex-col gap-8 max-w-full">
        ...
        <div className="bg-white/80 rounded-3xl p-8 border border-black/10 shadow-xl">
          ...
          <div className="text-base text-gray-800 leading-relaxed text-justify space-y-4 mb-6">
            <p>
          ...
          <div className="flex flex-wrap gap-3">
            {techTags.map((tech) => (
              <span
                key={tech}
                className="bg-blue-600 text-white py-2 px-4 rounded-lg text-sm font-medium border border-black/10 transition-transform duration-200 ease-in-out hover:-translate-y-0.5"
              >
                {tech}
              </span>
            ))}
